...
<div class="dokuwiki">
  ...
  <div class="stylehead">
    ...
    <div class="header">
      <div class="pagename">
        [[<a href="doku.php?id=start&amp;do=backlink"  title="Backlinks">start</a>]]
      </div>
      <div class="logo">
    ...
    <div class="bar" id="bar__top">
      ...
      <span class="bchead">Trace:</span> <span class="bcsep">&bull;</span> <span class="curid"><a href="doku.php?id=main:main"  class="breadcrumbs" title="main:main">main</a></span>          </div>
  ...
  <div class="stylefoot">
    ...
    <div class="bar" id="bar__bottom">
      ...
      <div class="bar-right" id="bar__bottomright">
                <form class="button btn_media" method="get" action="doku.php"><div class="no"><input type="hidden" name="do" value="media" /><input type="hidden" name="id" value="start" /><input type="submit" value="Media Manager" class="button" title="Media Manager" /></div></form>                        <form class="button btn_login" method="get" action="doku.php"><div class="no"><input type="hidden" name="do" value="login" /><input type="hidden" name="sectok" value="ee2695517457e85939d3b5dcc55f0e52" /><input type="hidden" name="id" value="start" /><input type="submit" value="Login" class="button" title="Login" /></div></form>        <form class="button btn_index" method="get" action="doku.php"><div class="no"><input type="hidden" name="do" value="index" /><input type="hidden" name="id" value="start" /><input type="submit" value="Sitemap" class="button" accesskey="x" title="Sitemap [X]" /></div></form>        <a class="nolink" href="doku.php#dokuwiki__top"><input type="button" class="button" value="Back to top" onclick="window.scrollTo(0, 0)" title="Back to top" /></a>&nbsp;
      </div>
      <div class="clearer"></div>
    </div>
