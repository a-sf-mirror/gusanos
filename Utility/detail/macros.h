...
#define forrange( i, b, e )\
  typedef __typeof__( b ) BOOST_PP_CAT(T_, __LINE__); BOOST_PP_CAT(T_, __LINE__) E_##EXPAND(__LINE__) = (e); for( BOOST_PP_CAT(T_, __LINE__) i = (b); i != BOOST_PP_CAT(E_, __LINE__); ++i )

#define forrange_delete( i, b, e )\
  typedef __typeof__( b ) BOOST_PP_CAT(T_, __LINE__); BOOST_PP_CAT(T_, __LINE__) E_##EXPAND(__LINE__) = (e); for( BOOST_PP_CAT(T_, __LINE__) i = (b), next; (i != BOOST_PP_CAT(E_, __LINE__)) && (next = i, ++next, true); i = next )
